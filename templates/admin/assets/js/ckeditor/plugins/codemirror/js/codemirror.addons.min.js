...
(p=Q?"string-2":"property","maybeprop"):H?(p=c.match(/^\s*:(?:\s|$)/,!1)?"property":"tag","block"):(p+=" errorr","maybeprop")):"meta"==a?"block":H||"hash"!=a&&"qualifier"!=a?B.top(a,c,b):(p="errorr","block")},B.maybeprop=function(a,c,b){return":"==a?n(b,c,"prop"):B[b.context.type](a,c,b)},B.prop=function(a,c,b){if(";"==a)return k(b);if("{"==a&&H)return n(b,c,"propBlock");if("}"==a||"{"==a)return h(a,c,b);if("("==a)return n(b,c,"parens");if("hash"!=a||/^#([0-9a-fA-f]{3,4}|[0-9a-fA-f]{6}|[0-9a-fA-f]{8})$/.test(c.current()))if("word"==
a)m(c);else{if("interpolation"==a)return n(b,c,"interpolation")}else p+=" errorr";return"prop"},B.propBlock=function(a,c,b){return"}"==a?k(b):"word"==a?(p="property","maybeprop"):b.context.type},B.parens=function(a,c,b){return"{"==a||"}"==a?h(a,c,b):")"==a?k(b):"("==a?n(b,c,"parens"):"interpolation"==a?n(b,c,"interpolation"):("word"==a&&m(c),"parens")},B.pseudo=function(a,c,b){return"meta"==a?"pseudo":"word"==a?(p="variable-3",b.context.type):B[b.context.type](a,c,b)},B.documentTypes=function(a,b,
...
P.hasOwnProperty(a)?Q?"string-2":"property":N.hasOwnProperty(a)?"atom":O.hasOwnProperty(a)?"keyword":"errorr");return c.context.type},B.atComponentBlock=function(a,b,c){return"}"==a?h(a,b,c):"{"==a?k(c)&&n(c,b,H?"block":"top",!1):("word"==a&&(p="errorr"),c.context.type)},B.atBlock_parens=function(a,c,b){return")"==a?k(b):"{"==a||"}"==a?h(a,c,b,2):B.atBlock(a,c,b)},B.restricted_atBlock_before=function(a,c,b){return"{"==a?n(b,c,"restricted_atBlock"):"word"==a&&"@counter-style"==b.stateArg?(p="variable",
"restricted_atBlock_before"):B[b.context.type](a,c,b)},B.restricted_atBlock=function(a,b,c){return"}"==a?(c.stateArg=null,k(c)):"word"==a?(p="@font-face"==c.stateArg&&!R.hasOwnProperty(b.current().toLowerCase())||"@counter-style"==c.stateArg&&!S.hasOwnProperty(b.current().toLowerCase())?"errorr":"property","maybeprop"):"restricted_atBlock"},B.keyframes=function(a,c,b){return"word"==a?(p="variable","keyframes"):"{"==a?n(b,c,"top"):B[b.context.type](a,c,b)},B.at=function(a,b,c){return";"==a?k(c):"{"==
a||"}"==a?h(a,b,c):("word"==a?p="tag":"hash"==a&&(p="builtin"),"at")},B.interpolation=function(a,c,b){return"}"==a?k(b):"{"==a||";"==a?h(a,c,b):("word"==a?p="variable":"variable"!=a&&"("!=a&&")"!=a&&(p="errorr"),"interpolation")},{startState:function(a){return{tokenize:null,state:l?"block":"top",stateArg:null,context:new f(l?"block":"top",a||0,null)}},token:function(a,b){if(!b.tokenize&&a.eatSpace())return null;var c=(b.tokenize||d)(a,b);return c&&"object"==typeof c&&(q=c[1],c=c[0]),p=c,"comment"!=
...
innerActive:null,inner:null}},copyState:function(b){return{outer:a.copyState(r,b.outer),innerActive:b.innerActive,inner:b.innerActive&&a.copyState(b.innerActive.mode,b.inner)}},token:function(b,e){if(e.innerActive){var f=e.innerActive,p=b.string;if(!f.close&&b.sol())return e.innerActive=e.inner=null,this.token(b,e);var h=f.close?q(p,f.close,b.pos,f.parseDelimitrs):-1;if(h==b.pos&&!f.parseDelimitrs)return b.match(f.close),e.innerActive=e.inner=null,f.delimStyle&&f.delimStyle+" "+f.delimStyle+"-close";
-1<h&&(b.string=p.slice(0,h));var t=f.mode.token(b,e.inner);return-1<h&&(b.string=p),h==b.pos&&f.parseDelimitrs&&(e.innerActive=e.inner=null),f.innerStyle&&(t=t?t+" "+f.innerStyle:f.innerStyle),t}for(var t=1/0,p=b.string,m=0;m<l.length;++m){f=l[m];h=q(p,f.open,b.pos);if(h==b.pos)return f.parseDelimitrs||b.match(f.open),e.innerActive=f,p=0,r.indent&&(h=r.indent(e.outer,"",""),h!==a.Pass&&(p=h)),e.inner=a.startState(f.mode,p),f.delimStyle&&f.delimStyle+" "+f.delimStyle+"-open";-1!=h&&h<t&&(t=h)}t!=
