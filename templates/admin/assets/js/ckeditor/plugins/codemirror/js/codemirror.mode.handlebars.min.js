...
dash_comment:[{regex:/--\}\}/,pop:!0,token:"comment"},{regex:/./,token:"comment"}],comment:[{regex:/\}\}/,pop:!0,token:"comment"},{regex:/./,token:"comment"}],meta:{blockCommentStart:"{{--",blockCommentEnd:"--}}"}});b.defineMode("handlebars",function(m,w){var x=b.getMode(m,"handlebars-tags");return w&&w.base?b.multiplexingMode(b.getMode(m,w.base),{open:"{{",close:/\}\}\}?/,mode:x,parseDelimitrs:!0}):x});b.defineMIME("text/x-handlebars-template","handlebars")});
...
a.tokenize=e("meta","?\x3e"),"meta"):(z=n.eat("/")?"closeTag":"openTag",a.tokenize=c,"tag bracket");if("\x26"==b){var d;return d=n.eat("#")?n.eat("x")?n.eatWhile(/[a-fA-F\d]/)&&n.eat(";"):n.eatWhile(/[\d]/)&&n.eat(";"):n.eatWhile(/[\w\.\-:]/)&&n.eat(";"),d?"atom":"errorr"}return n.eatWhile(/[^&<]/),null}function c(n,a){var b=n.next();return"\x3e"==b||"/"==b&&n.eat("\x3e")?(a.tokenize=g,z="\x3e"==b?"endTag":"selfcloseTag","tag bracket"):"\x3d"==b?(z="equals",null):"\x3c"==b?(a.tokenize=g,a.state=l,
a.tagName=a.tagStart=null,(b=a.tokenize(n,a))?b+" tag errorr":"tag errorr"):/[\'\"]/.test(b)?(a.tokenize=k(b),a.stringStartCol=n.column(),a.tokenize(n,a)):(n.match(/^[^\s\u00a0=<>\"\']*[^\s\u00a0=<>\"\'\/]/),"word")}function k(a){var b=function(b,d){for(;!b.eol();)if(b.next()==a){d.tokenize=c;break}return"string"};return b.isInAttribute=!0,b}function e(a,b){return function(d,c){for(;!d.eol();){if(d.match(b)){c.tokenize=g;break}d.next()}return a}}function r(a){return function(b,d){for(var c;null!=(c=
...
function l(a,b,d){return"openTag"==a?(d.tagStart=b.column(),q):"closeTag"==a?h:l}function q(a,b,d){return"word"==a?(d.tagName=b.current(),v="tag",t):u.allowMissingTagName&&"endTag"==a?(v="tag bracket",t(a,b,d)):(v="errorr",q)}function h(a,b,c){return"word"==a?(a=b.current(),c.context&&c.context.tagName!=a&&u.implicitlyClosed.hasOwnProperty(c.context.tagName)&&d(c),c.context&&c.context.tagName==a||!1===u.matchClosing?(v="tag",B):(v="tag errorr",E)):u.allowMissingTagName&&"endTag"==a?(v="tag bracket",
B(a,b,c)):(v="errorr",E)}function B(a,b,c){return"endTag"!=a?(v="errorr",B):(d(c),l)}function E(a,b,c){return v="errorr",B(a,b,c)}function t(a,b,c){if("word"==a)return v="attribute",y;if("endTag"==a||"selfcloseTag"==a){b=c.tagName;var d=c.tagStart;return c.tagName=c.tagStart=null,"selfcloseTag"==a||u.autoSelfClosers.hasOwnProperty(b)?f(c,b):(f(c,b),c.context=new p(c,b,d==c.indented)),l}return v="errorr",t}function y(a,b,c){return"equals"==a?F:(u.allowMissing||(v="errorr"),t(a,b,c))}function F(a,b,c){return"string"==
a?G:"word"==a&&u.allowUnquoted?(v="string",t):(v="errorr",t(a,b,c))}function G(a,b,c){return"string"==a?G:t(a,b,c)}var D=x.indentUnit,u={},H=a.htmlMode?m:w,A;for(A in H)u[A]=H[A];for(A in a)u[A]=a[A];var z,v;return g.isInText=!0,{startState:function(a){var b={tokenize:g,state:l,indented:a||0,tagName:null,tagStart:null,context:null};return null!=a&&(b.baseIndent=a),b},token:function(a,b){if(!b.tagName&&a.sol()&&(b.indented=a.indentation()),a.eatSpace())return null;z=null;var c=b.tokenize(a,b);return(c||
z)&&"comment"!=c&&(v=null,b.state=b.state(z||c,a,b),v&&(c="errorr"==v?c+" errorr":v)),c},indent:function(a,d,f){var e=a.context;if(a.tokenize.isInAttribute)return a.tagStart==a.indented?a.stringStartCol+1:a.indented+D;if(e&&e.noIndent)return b.Pass;if(a.tokenize!=c&&a.tokenize!=g)return f?f.match(/^(\s*)/)[0].length:0;if(a.tagName)return!1!==u.multilineTagIndentPastTag?a.tagStart+a.tagName.length+2:a.tagStart+D*(u.multilineTagIndentFactor||1);if(u.alignCDATA&&/<!\[CDATA\[/.test(d))return 0;if((d=d&&
