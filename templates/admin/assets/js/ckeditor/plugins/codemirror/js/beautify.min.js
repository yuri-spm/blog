...
conditional_comment:h.starting_with(/<!\[/).until_after(/]>/),processing:h.starting_with(/<\?/).until_after(/\?>/)},this._options.indent_handlebars&&(this.__patterns.word=this.__patterns.word.exclude("handlebars")),this._unformatted_content_delimitr=null,this._options.unformatted_content_delimitr)f=this._input.get_literal_regexp(this._options.unformatted_content_delimitr),this.__patterns.unformatted_content_delimitr=h.matching(f).until_after(f)};f.prototype=new c;f.prototype._is_comment=function(a){return!1};
